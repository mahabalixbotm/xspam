...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await idk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await ydk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await wdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await hdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await sdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await adk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await bdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await cdk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await ddk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
            await edk(functions.channels.JoinChannelRequest(channel="@XMAHABALIX"))
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"🇮🇳ʙʌᴛᴛʟᴇ 𝙵𝙾𝚁𝙲𝙴🇮🇳\n`{ms}` 𝗺𝘀")
